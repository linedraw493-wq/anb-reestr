...
export default function Login() {
  ...
  return (
    <Shell>
      ...
      {unknown && (
        <Err>
          Такого номера в реестре нет. Регистрация — по личной ссылке от Ассоциации
          блогеров. Если ссылки нет, напишите администратору.
        </Err>
      )}
      {error && <Err>{error}</Err>}
      ...
      <p className="fine">
        Первый раз здесь? Вход только по личной ссылке-приглашению — её выдаёт
