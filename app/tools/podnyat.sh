...
export MASTER_KOD_TELEFONY="$(znach MASTER_KOD_TELEFONY)"
export VLADELETS_TELEFON="$(znach VLADELETS_TELEFON)"
export VLADELETS_IMYA="$(znach VLADELETS_IMYA)"
export ADMIN_TELEFONY="$(znach ADMIN_TELEFONY)"
export ANTHROPIC_API_KEY="$(znach ANTHROPIC_API_KEY)"
export MOBIZON_API_KEY="$(znach MOBIZON_API_KEY)"
export MOBIZON_PODPIS="$(znach MOBIZON_PODPIS)"
