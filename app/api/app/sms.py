...
# Текст SMS. Два правила, оба жёсткие:
#
# 1. **Название компании обязано быть в тексте.** Это требование самого
#    Mobizon, написанное у него на экране отправки: «в тексте сообщения
#    необходимо указывать название компании или бренда, в противном случае
#    SMS может быть отклонено». Первый вариант текста бренда не называл —
#    провайдер отчитывался «доставлено», а на телефон ничего не приходило.
#    Поправлено 06.09.2026, после того как владелец сказал «не пришла смс».
# 2. Кириллица считается по 70 знаков на сообщение. Длиннее — платим вдвое.
SHABLON = "Ассоциация блогеров: код {kod}. Никому не говорите."
